        ...
        <div className="bummps-testimonials w-full mt-12 sm:mt-16 relative">
          ...
          >
            {testimonialData.map((t, idx) => (
              <SwiperSlide key={t.name || idx} className="!h-auto py-4">
                {/* Testimonial Card */}
                <div className="testimonial-card relative bg-neutral-900/60 backdrop-blur-xl border border-[#DAB25A]/20 rounded-3xl p-7 sm:p-8 shadow-[0_15px_35px_rgba(0,0,0,0.6)] h-full max-w-md mx-auto transition-all duration-500 flex flex-col justify-between group overflow-hidden">
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 bg-[#DAB25A]/10 border border-[#DAB25A]/20 px-2.5 py-1 rounded-full text-xs text-[#DAB25A] font-semibold">
                    ...
                    {/* Review Text */}
                    <p className="mt-5 text-neutral-300 leading-relaxed text-sm sm:text-base font-normal">
                      "{t.review}"
                    </p>
                  </div>

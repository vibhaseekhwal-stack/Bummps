...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="relative pt-0 pb-20 sm:pt-4 sm:pb-20 bg-[#121214] text-white overflow-hidden font-['Plus_Jakarta_Sans',sans-serif]"
    >
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative w-full max-w-md">
              ...
              <div className="absolute -bottom-4 right-6 bg-neutral-950 border border-[#DAB25A]/30 px-4 py-2 rounded-full flex items-center gap-2 shadow-2xl">
                ...
                <span className="text-[11px] font-bold text-[#DAB25A] uppercase tracking-widest">
                  Verified & Secure
                </span>
              </div>
            </div>
          ...
          >
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.2em] text-[#DAB25A] uppercase bg-[#DAB25A]/10 border border-[#DAB25A]/30 px-3.5 py-1.5 rounded-full">
                <PiHeartFill className="text-[#DAB25A]" /> About Bummps
              </span>
            </motion.div>

            {/* HEADING WITH FEATURES THEME GRADIENT STYLING */}
            <h2 className="font-['Playfair_Display',serif] font-bold text-2xl sm:text-4xl lg:text-5xl text-white leading-tight tracking-tight">
              Dating, minus the{" "}
            ...
            <p className="text-neutral-300 text-base sm:text-lg leading-relaxed font-light sm:font-normal">
            ...
            <p className="text-neutral-300/80 text-sm sm:text-base leading-relaxed font-light sm:font-normal">
            ...
            <div className="pt-2 grid grid-cols-2 gap-6 max-w-sm">
              <div className="border-l-2 border-[#DAB25A] pl-4 transition-all duration-300 hover:border-[#F3E5AB]">
                <p className="font-['Playfair_Display',serif] text-3xl sm:text-4xl font-bold text-[#DAB25A]">
                  <Counter value={12} suffix="M+" />
                </p>
                <p className="text-xs sm:text-sm text-neutral-400 mt-1 uppercase tracking-wider font-medium">
                  Happy members
                </p>
              </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="bg-[#DAB25A] hover:bg-[#c49e48] text-black font-bold uppercase tracking-wider px-8 py-4 rounded-full shadow-[0_4px_20px_rgba(218,178,90,0.3)] transition-all duration-300 active:scale-95 cursor-pointer text-sm"
              >
                Learn Our Story
              </button>
            </div>

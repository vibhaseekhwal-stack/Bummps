      ...
      >
        ...
        <div className="hidden lg:flex lg:col-span-5 relative flex-col justify-between p-10 bg-neutral-900/30 border-r border-white/10 backdrop-blur-2xl">
          ...
          <div className="relative z-10 my-auto py-12">
            ...
            <h2 className="font-sans text-3xl font-bold leading-tight text-white">
              Find your{" "}
              <span className="font-sans font-extrabold bg-linear-to-r from-[#DAB25A] via-[#F3E5AB] to-[#DAB25A] bg-clip-text text-transparent">
                perfect
              </span>{" "}
              match today.
            </h2>
        ...
        <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-center">
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <p className="mt-2 text-xs sm:text-sm text-neutral-300 font-normal">

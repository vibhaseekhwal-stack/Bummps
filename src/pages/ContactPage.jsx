                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="mt-10 sm:mt-12 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10 items-stretch">
                        <motion.div
                            ...
                            className="lg:col-span-5 rounded-2xl sm:rounded-3xl p-6 sm:p-8 bg-neutral-900/40 border border-[#DAB25A]/20 backdrop-blur-xl shadow-2xl flex flex-col justify-between relative overflow-hidden"
                        >
                            ...
                            <div className="space-y-6 sm:space-y-8 relative z-10">
                                <div>
                                    <div className="inline-flex items-center gap-2 rounded-full border border-[#DAB25A]/30 bg-[#DAB25A]/10 px-3 py-1 text-[11px] font-bold text-[#DAB25A] mb-3">
                                        <PiLightningFill />
                                        <span>Instant Reach Desk</span>
                                    </div>
                                    <h3 className="font-['Playfair_Display',serif] text-2xl sm:text-3xl font-bold text-white tracking-wide">
                                ...
                                <div className="space-y-4 pt-4 border-t border-[#DAB25A]/10">
                                    <div className="p-4 rounded-2xl bg-neutral-950/60 border border-white/5 space-y-2">
                                        <span className="text-[10px] font-bold uppercase tracking-wider text-[#DAB25A]">
                                            Global Support Desk
                                        </span>
                                        <p className="text-sm font-bold text-white">support@bummps.com</p>
                                    ...
                                    <div className="p-4 rounded-2xl bg-neutral-950/60 border border-white/5 space-y-2">
                                        ...
                                        <p className="text-sm font-bold text-white">+1 (800) 555-0142 / +91 98765 43210</p>
                        ...
                        <motion.form
                            ...
                            className="lg:col-span-7 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 bg-neutral-900/40 border border-[#DAB25A]/20 backdrop-blur-xl shadow-2xl space-y-4 sm:space-y-6 flex flex-col justify-between"
                        >
                                    ...
                                    <div>
                                        ...
                                        <div className="relative" ref={dropdownRef}>
                                            ...
                                            <button
                                                ...
                                                className={`w-full rounded-2xl border bg-neutral-900/60 py-3.5 sm:py-4 pl-11 sm:pl-12 pr-10 text-xs sm:text-sm text-left text-white transition-all duration-300 flex items-center justify-between ${isDropdownOpen
                                                        ? "border-[#DAB25A] ring-1 ring-[#DAB25A] shadow-[0_0_20px_rgba(218,178,90,0.15)]"
                                                        : "border-[#DAB25A]/20 hover:border-[#DAB25A]/50"
                                                    }`}
                                            >
                                                <span>{selectedCategory.label}</span>
                                                <PiCaretDownBold
                                                    className={`text-[#DAB25A] text-base transition-transform duration-300 ${isDropdownOpen ? "rotate-180" : ""
                                                        }`}
                                                />
                                            </button>
                                            ...
                                            <AnimatePresence>
                                                {isDropdownOpen && (
                                                    <motion.ul
                                                        ...
                                                        className="absolute z-50 mt-2 w-full rounded-2xl border border-[#DAB25A]/30 bg-[#17171a] p-1.5 shadow-[0_10px_30px_rgba(0,0,0,0.8)] backdrop-blur-2xl overflow-hidden"
                                                    >
                                                        {categories.map((item) => (
                                                            <li key={item.value}>
                                                                <button
                                                                    ...
                                                                    className={`w-full rounded-xl px-4 py-2.5 text-xs sm:text-sm text-left transition-all duration-200 flex items-center justify-between ${selectedCategory.value === item.value
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3.5 sm:py-4 rounded-full font-bold uppercase tracking-wider text-xs sm:text-sm bg-[#DAB25A] hover:bg-[#c49e48] text-black shadow-[0_4px_25px_rgba(218,178,90,0.3)] transition-all duration-300 active:scale-95 cursor-pointer flex items-center justify-center gap-2 outline-none mt-4 disabled:opacity-60"
                            >
                                {loading ? (
